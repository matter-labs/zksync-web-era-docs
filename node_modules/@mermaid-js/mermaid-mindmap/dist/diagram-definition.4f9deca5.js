...
}, Qu = { drawNode: Id, positionNode: Rd, drawEdge: kd };
...
var Qd = Zd, Jd = Za, jd = Jd.Symbol, ls = jd, eo = ls, Ju = Object.prototype, eg = Ju.hasOwnProperty, tg = Ju.toString, ln = eo ? eo.toStringTag : void 0;
function rg(t) {
...
var og = sg, to = ls, ug = ng, lg = og, fg = "[object Null]", cg = "[object Undefined]", ro = to ? to.toStringTag : void 0;
function hg(t) {
  return t == null ? t === void 0 ? cg : fg : ro && ro in Object(t) ? ug(t) : lg(t);
}
var ju = hg;
function vg(t) {
...
var Vn = mg, bg = Qd, no = Hn, wg = Vn, ao = 0 / 0, Eg = /^[-+]0x[0-9a-f]+$/i, xg = /^0b[01]+$/i, Tg = /^0o[0-7]+$/i, Cg = parseInt;
function Dg(t) {
  if (typeof t == "number")
    return t;
  if (wg(t))
  ...
  t = bg(t);
  var r = xg.test(t);
  return r || Tg.test(t) ? Cg(t.slice(2), r ? 2 : 8) : Eg.test(t) ? ao : +t;
}
var Sg = Dg, Lg = Hn, bi = Yd, io = Sg, Ag = "Expected a function", Ng = Math.max, Mg = Math.min;
function Og(t, e, r) {
  var n, a, i, s, o, u, l = 0, f = !1, c = !1, v = !0;
  if (typeof t != "function")
    throw new TypeError(Ag);
  e = io(e) || 0, Lg(r) && (f = !!r.leading, c = "maxWait" in r, i = c ? Ng(io(r.maxWait) || 0, e) : i, v = "trailing" in r ? !!r.trailing : v);
  function h(D) {
    var w = n, T = a;
...
var Ig = Og, el = { exports: {} }, tl = { exports: {} };
(function(t, e) {
  (function() {
...
var qg = Xg, Wg = Za, Kg = Wg["__core-js_shared__"], Zg = Kg, wi = Zg, so = function() {
...
var fs = wp, Ep = fs, xp = Ep(Object, "create"), Ja = xp, oo = Ja;
function Tp() {
...
Zr.prototype.has = py;
Zr.prototype.set = yy;
var my = Zr, by = fs, wy = Za, Ey = by(wy, "Map"), xy = Ey, uo = qp, Ty = my, Cy = xy;
function Dy() {
...
Qr.prototype.has = Xy;
Qr.prototype.set = qy;
var Wy = Qr, nl = Wy, Ky = "Expected a function";
function cs(t, e) {
...
var il = i0, lo = ls, s0 = il, o0 = Qa, u0 = Vn, l0 = 1 / 0, fo = lo ? lo.prototype : void 0, co = fo ? fo.toString : void 0;
function sl(t) {
  if (typeof t == "string")
    return t;
  if (o0(t))
...
var ol = h0, v0 = Qa, d0 = $g, g0 = al, p0 = ol;
function y0(t, e) {
  return v0(t) ? t : d0(t, e) ? [t] : g0(p0(t));
}
var ul = y0, m0 = Vn, b0 = 1 / 0;
function w0(t) {
...
var I0 = O0, k0 = I0, R0 = rl, P0 = Object.prototype, B0 = P0.hasOwnProperty;
function F0(t, e, r) {
  var n = t[e];
...
var H0 = z0, V0 = _0, Y0 = ul, U0 = H0, vo = Hn, X0 = hs;
function q0(t, e, r, n) {
  if (!vo(t))
    return t;
  e = Y0(e, t);
  for (var a = -1, i = e.length, s = i - 1, o = t; o != null && ++a < i; ) {
    ...
    if (a != s) {
      var f = o[u];
      l = n ? n(f, u, o) : void 0, l === void 0 && (l = vo(f) ? f : U0(e[a + 1]) ? [] : {});
    }
    V0(o, u, l), o = o[u];
  }
  return t;
...
var j0 = J0, em = il, tm = j0, rm = Qa, nm = Vn, am = al, im = hs, sm = ol;
function om(t) {
  return rm(t) ? em(t, im) : nm(t) ? [t] : tm(am(sm(t)));
}
var um = om, lm = Ig, fm = el.exports, cm = L0, hm = Q0, vm = um;
function Yn(t) {
...
var Be = typeof window > "u" ? null : window, yo = Be ? Be.navigator : null;
Be && Be.document;
var Em = Ve(""), fl = Ve({}), xm = Ve(function() {
  ...
  return e != null && Ve(e) === fl && !Ie(e) && e.constructor === Object;
}, Cm = function(e) {
...
}, He = "(?:[-+]?(?:(?:\\d+|\\d*\\.\\d+)(?:[Ee][+-]?\\d+)?))", Om = "rgb[a]?\\((" + He + "[%]?)\\s*,\\s*(" + He + "[%]?)\\s*,\\s*(" + He + "[%]?)(?:\\s*,\\s*(" + He + "))?\\)", Im = "rgb[a]?\\((?:" + He + "[%]?)\\s*,\\s*(?:" + He + "[%]?)\\s*,\\s*(?:" + He + "[%]?)(?:\\s*,\\s*(?:" + He + "))?\\)", km = "hsl[a]?\\((" + He + ")\\s*,\\s*(" + He + "[%])\\s*,\\s*(" + He + "[%])(?:\\s*,\\s*(" + He + "))?\\)", Rm = "hsl[a]?\\((?:" + He + ")\\s*,\\s*(?:" + He + "[%])\\s*,\\s*(?:" + He + "[%])(?:\\s*,\\s*(?:" + He + "))?\\)", Pm = "\\#[0-9a-fA-F]{3}", Bm = "\\#[0-9a-fA-F]{6}", dl = function(e, r) {
  ...
  return r;
}, Ei = Be ? Be.performance : null, yl = Ei && Ei.now ? function() {
  return Ei.now();
} : function() {
  return Date.now();
}, Ym = function() {
  ...
  return r;
}, bo = !0, Wm = console.warn != null, Km = console.trace != null, ys = Number.MAX_SAFE_INTEGER || 9007199254740991, El = function() {
  return !0;
}, Ga = function() {
  return !1;
}, wo = function() {
  ...
  !xl() || (Wm ? console.warn(e) : (console.log(e), Km && console.trace()));
}, Zm = function(e) {
  return he({}, e);
}, Ot = function(e) {
...
var z1 = Qe({
  ...
  euclidean: function(e, r, n) {
    return e >= 2 ? fn(e, r, n, 0, Lo, eb) : fn(e, r, n, 0, So);
  },
...
}, lw = Object.keys(Ho).reduce(function(t, e) {
  var r = Ho[e], n = uw(e);
  return t[e] = function() {
...
var Jl = /^([^.]+)(\.(?:[^.]+))?$/, cw = ".*", jl = {
  ...
  context: null
}, Vo = Object.keys(jl), hw = {};
function oi() {
  for (var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : hw, e = arguments.length > 1 ? arguments[1] : void 0, r = 0; r < Vo.length; r++) {
    var n = Vo[r];
    this[n] = t[n] || jl[n];
  }
...
[Fl, kb, Ta, tr, Wr, Kb, si, fw, tf, rf, gw, Ha, Ca, Ke, rr, rt].forEach(function(t) {
  he(Re, t);
});
var xw = {
  add: function(e) {
...
nt.append = function(t) {
  return hl(t) ? t.appendToStyle(this) : Ie(t) ? this.appendFromJson(t) : le(t) && this.appendFromString(t), this;
};
...
var Iw = {
  ...
  setStyle: function(e) {
    var r = this._private;
    return hl(e) ? r.style = e.generateStyle(this) : Ie(e) ? r.style = tt.fromJson(this, e) : le(e) ? r.style = tt.fromString(this, e) : r.style = tt(this), r.style;
  },
...
[xw, Lw, sf, Wi, Sa, Nw, Ki, La, Iw, Er, _n].forEach(function(t) {
  he(Va, t);
});
var Rw = {
  fit: !0,
        ...
        switch (n.edgeType) {
          ...
          case "haystack": {
            for (var O = 0, N, R, I, k, P = n.allpts.length, B = 0; B + 3 < P && (h ? (I = {
              ...
              ;
            var _ = d - R, F = _ / N;
            F = Rn(0, F, 1), e = x1(I, k, F), v = yf(I, k);
            break;
          }
        }
...
}(), lu = 25, pa = 50, Aa = -4, Zi = 3, lE = 7.99, fE = 8, cE = 1024, hE = 1024, vE = 1024, dE = 0.2, gE = 0.8, pE = 10, yE = 0.15, mE = 0.1, bE = 0.9, wE = 0.9, EE = 100, xE = 1, _r = {
  dequeue: "dequeue",
  downscale: "downscale",
...
Ye.getElement = function(t, e, r, n, a) {
  ...
  if (h && h.invalidated && (h.invalidated = !1, h.texture.invalidatedWidth -= h.width), h)
    return h;
  var d;
  if (f <= lu ? d = lu : f <= pa ? d = pa : d = Math.ceil(f / pa) * pa, f > vE || c > hE)
    return null;
...
var CE = 1, xn = -4, Xa = 2, DE = 3.99, SE = 50, LE = 50, AE = 0.15, NE = 0.1, ME = 0.9, OE = 0.9, IE = 1, fu = 250, kE = 4e3 * 4e3, RE = !0, Tf = function(e) {
...
}, Je = Tf.prototype, cu = 0, PE = Math.pow(2, 53) - 1;
...
const nx = /* @__PURE__ */ Pd(Ff.exports);
Bf.use(nx);
function _f(t, e, r, n) {
...
` + t);
  ...
  ax(f, v), sx(v), wu(void 0, u, a.mindmap.padding, a.mindmap.useMaxWidth);
}, ux = {
  draw: ox
}, Na = {
  min: {
...
const mx = yx, bx = new mx({ r: 0, g: 0, b: 0, a: 0 }, "transparent"), ks = bx, Gf = {
...
}, Hf = Lx, Ax = (t, e) => Hf(t, "l", e), Nx = Ax, Mx = (t, e) => Hf(t, "l", -e), Ox = Mx, Ix = (t) => {
  let e = "";
...
//# sourceMappingURL=diagram-definition.4f9deca5.js.map
