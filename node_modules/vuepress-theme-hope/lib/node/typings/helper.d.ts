...
import type { BlogPluginOptions, NavbarOptions, SidebarOptions, SidebarArrayOptions, SidebarObjectOptions } from "../../shared/index.js";
...
export type ThemeFeedPluginHelper = Helper<Omit<FeedOptions, "hostname"> | false>;
...
export type ThemeSEOPluginHelper = Helper<Omit<SeoOptions, "hostname" | "author"> | false>;
export type ThemeSitemapPluginHelper = Helper<Omit<SitemapOptions, "hostname"> | false>;
export {};
