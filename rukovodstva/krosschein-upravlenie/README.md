...
В этом руководстве предполагается, что вы уже знакомы с развертыванием смарт-контрактов на zkSync. Если это не так, обратитесь к разделу [быстрый старт.](../../razrabotka-na-zksync/bystryi-start/)&#x20;
