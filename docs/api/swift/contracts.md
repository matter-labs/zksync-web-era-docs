...
head:
  - - meta
    - name: "twitter:title"
      content: Swift SDK Contracts | zkSync Era Docs
---
...
Contract instantiation is the same as in the [`geth`](https://geth.ethereum.org/docs/developers/dapp-developer/native-bindings) library.
