...
To provide easy access to all of the features of zkSync Era, the `zksync-web3` JavaScript SDK was created, which is based on the `ethers` JavaScript library. This section serves as its reference.
