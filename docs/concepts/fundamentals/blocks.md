...
| transactions  | An array of transaction objects - please see [interface TransactionResponse]() for exact shape                                                                     |
...
After submitting them, blocks will go through different stages as explained [here]().
