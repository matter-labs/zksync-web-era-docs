...
To run this script, configure your `hardhat.config.ts` file as explained in this [guide](), or use the command `npx zksync-cli@latest create PROJECT_NAME` to scaffold a new project.
