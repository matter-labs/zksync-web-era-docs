...
[Learn more about EIP712 transactions here](../../../concepts/transaction-lifecycle.md#eip-712-0x71).
...
Here's a [step-by-step guide on how to use it](../../../../build/tooling/hardhat/getting-started.md).
...
Both of these examples are already seamlessly done under the hood by our [hardhat-zksync-deploy](../../../../build/tooling/hardhat/hardhat-zksync-deploy.md).
...
- [Security considerations and best practices on zkSync](../../../../build/quick-start/best-practices.md)
