...
:::tip Best practices
It's highly recommended to review the best practices and key considerations for creating smart contracts on zkSync Era section [here](../../../../build/quick-start/best-practices.md).
:::
...
check out the [blocks on zkSync Documentation](../../../concepts/blocks.md).
