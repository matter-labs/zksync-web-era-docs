...
We have four circuits, that receive some queue of elements and do sorting and deduplicating: [SortDecommitments](./sort-decommitments.md), [StorageSorter](./storage-sorter.md),
EventsSorter and L1MessageSorter (Both EventsSorter and L1MessageSorter use [LogSorter](./log-sorter.md)).
