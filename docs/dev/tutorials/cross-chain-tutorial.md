...
```
::: tip
In case of any issues on this step (f.e. you did not have a yarn), you may get errors during the recreation of the project environment. Clean your current enviroment in advance or create another folder and create enviroment there.
:::
