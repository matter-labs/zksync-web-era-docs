...
- `_index` is a parameter that contains the serial number of the message in the L2 block. Can be restored both from observing Ethereum and received via API.
