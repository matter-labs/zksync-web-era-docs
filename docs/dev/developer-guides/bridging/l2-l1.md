...
Sending messages from the L2 side requires users to call the `sendToL1` method from the [Messenger system contract](../system-contracts.md#understanding-system-contracts##IL1Messenger). This method accepts only the bytes of the message that is being sent to the zkSync smart contract on L1.
...
More information about Messenger can be found in the [system contracts section](../system-contracts.md#understanding-system-contracts##IL1Messenger).
