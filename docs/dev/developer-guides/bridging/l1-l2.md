...
At the moment, all the L1-> L2 transactions are served at the FIFO basis, but in the future we will introduce "priority heap", which will allow for sorting the transactions.
