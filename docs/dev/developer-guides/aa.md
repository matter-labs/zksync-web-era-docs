...
- Before each transaction starts, the system queries the [NonceHolder](../developer-guides/system-contracts.md#inonceholder) to check whether the provided nonce has already been used or not.
