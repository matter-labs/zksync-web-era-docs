...
It is possible to continue the SDKs that are currently implemented. Users will continue paying fees in ETH and the UX will be identical to the one on Ethereum.
