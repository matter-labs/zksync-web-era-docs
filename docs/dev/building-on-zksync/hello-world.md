...
# For Yarn
yarn init -y
yarn add -D typescript ts-node ethers@^5.7.2 zksync-web3@^0.14 hardhat @matterlabs/hardhat-zksync-solc^0.3.14 @matterlabs/hardhat-zksync-deploy

# For NPM
npm init -y
npm i -D typescript ts-node ethers@^5.7.2 zksync-web3@^0.14 hardhat @matterlabs/hardhat-zksync-solc^0.3.14 @matterlabs/hardhat-zksync-deploy
```
