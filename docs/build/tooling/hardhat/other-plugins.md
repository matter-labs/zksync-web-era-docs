...
Although this plugin works out of the box, zkSync Era has a [different fee model](../../technical-reference/concepts/fee-model.md) than Ethereum. Users should consider this when analysing the report generated by this plugin.

In addition, make sure to read about [local testing](../../test-and-debug/README.md).
