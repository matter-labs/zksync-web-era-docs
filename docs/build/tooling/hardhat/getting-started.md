...
This tutorial shows you how to set up a zkSync Era Solidity project with Hardhat using the [zkSync CLI](../zksync-cli/getting-started.md).
...
- Contracts must be compiled using the [official zkSync Era compilers](../../../zk-stack/components/compiler/toolchain/README.md), with their respective Hardhat plugins.
