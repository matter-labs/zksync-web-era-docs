...
- You have a wallet with sufficient Sepolia or Goerli `ETH` on L1 to pay for bridging funds to zkSync as well as deploying smart contracts. Use the [third party faucets](../../support/faq.md#how-do-i-request-funds-for-testnet) to get some test tokens in your account.
...
For more details about a dockerized local setup, check out [Local testing](../../test-and-debug/README.md).
:::
