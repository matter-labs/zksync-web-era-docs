...
If you want some background on how L1->L2 interaction works on zkSync Era, go through the [L1 / L2 interoperability doc](../../technical-reference/concepts/l1-l2-interop.md).
