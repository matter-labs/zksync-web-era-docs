...
If you want to get some background on how L1->L2 interaction works on zkSync Era, go through the [introduction](../../technical-reference/concepts/l1-l2-interop.md).
