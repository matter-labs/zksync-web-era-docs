...
The following are the block properties returned when you use the `getBlock` method from the API using any of our SDKs, since JS SDK is the most popular one, you can start [here](../../sdks/js/README.md).
...
| transactions  | An array of transaction objects - please see [interface TransactionResponse](../../sdks/js/providers.md#gettransaction) for exact shape   |
