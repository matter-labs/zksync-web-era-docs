...
An example of how to use testnet paymaster can be seen in the [frontend quickstart](../../../build/tutorials/dapp-development/frontend-quickstart-paymaster.md#paying-fees-using-testnet-paymaster) tutorial.
