...
::: info
The native account abstraction of zkSync and Ethereum's EIP 4337 aim to enhance accounts' flexibility and user experience, but they differ in key aspects; learn more [here](../../../development/compiler/architecture/differences-with-ethereum.md#native-aa-vs-eip-4337).
:::
...
- Before each transaction starts, the system queries the [NonceHolder](../../../development/compiler/architecture/system-contracts.md#nonceholder) to check whether the provided nonce has already been used or not.
...
For optimization purposes, both [tx nonce and the deployment nonce](../../../development/compiler/architecture/contract-deployment.md#differences-in-create-behaviour) are put in one storage slot inside the [NonceHolder](../../../development/compiler/architecture/system-contracts.md#nonceholder) system contracts.
