...
To run this script, configure your `hardhat.config.ts` file as explained in this [guide](../hardhat-plugins/hardhat-zksync-deploy.md), or use the command `npx zksync-cli create --template hardhat_solidity` to scaffold a new project.
