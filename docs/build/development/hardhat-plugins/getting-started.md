...
- Contracts must be compiled using the [official zkSync Era compilers](../compiler/compiler-toolchain/README.md), with their respective Hardhat plugins.
...
- If you want to know more about how to interact with zkSync using Javascript, check out the [zksync-ethers Javascript SDK documentation](../sdks/javascript/README.md) .
