...
You can find the L1 system contract addresses in the [useful addresses page](../../../building-on-zksync/useful-address.md).
:::
...
The facet that handles L2 <-> L1 communication, an overview for which can be found in the [L1 / L2 Interoperability guide](../../../technical-reference/concepts/l1-l2-interop.md).
