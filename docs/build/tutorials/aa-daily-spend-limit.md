...
- If you are not already familiar with deploying smart contracts on zkSync Era, please refer to the first section of the [quickstart tutorial]().
- You have a web3 wallet app which holds some Goerli test ETH and some zkSync Era test ETH.
- You know how to get your [private key from your MetaMask wallet](https://support.metamask.io/hc/en-us/articles/360015289632-How-to-export-an-account-s-private-key).
- We encourage you to read [the basics of account abstraction on zkSync Era]() and complete the [multisig account tutorial](./custom-aa-tutorial.md) before attempting this tutorial.
...
3. Add additional packages that use [zkSync Era smart contracts]().
...
- Find [more info about the zkSync Era CLI here]().
:::
...
The account needs to implement the [IAccount]() interface and inherits the `SpendLimit` contract we just created. Since we are building an account with signers, we should also implement [EIP1271](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/83277ff916ac4f58fec072b8f28a252c1245c2f1/contracts/interfaces/IERC1271.sol#L12).
...
- Neither the well-known `0xEee...EEeE` used by protocols as a placeholder on Ethereum, nor the zero address `0x000...000`, that ([`zksync-web3` provides]() has a more user-friendly alias.
:::
...
- To learn more about L1->L2 interaction on zkSync Era, check out the [documentation]().
