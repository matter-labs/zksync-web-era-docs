...
<p>zkSync is fully compatible with <a href="https://geth.ethereum.org/docs/rpc/pubsub" target="_blank" rel="noopener noreferrer">Geth's pubsub API<ExternalLinkIcon/></a>, except for the <code v-pre>syncing</code> subscription. This is because nodes on the zkSync network are technically always synchronized.</p>
<p>The WebSocket URL is <code v-pre>wss://zksync2-testnet.zksync.dev/ws</code>.</p>
<div class="hint-container tip">
<p class="hint-container-title">Tips</p>
<p>You can use the websocket endpoint to handle smart contract events, as detailed <RouterLink to="/dev/developer-guides/building-on-zksync/events.html">in this section of the docs</RouterLink>.</p>
</div>
</div></template>
