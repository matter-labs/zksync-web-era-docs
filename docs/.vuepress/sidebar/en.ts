...
export const enSidebar = sidebar({
  ...
  "/dev": [
    ...
    },
    {
      ...
      children: ["/dev/fundamentals/lorem.md", "/dev/fundamentals/rollups.md", "/dev/fundamentals/zkSync-basics.md", "/dev/fundamentals/interacting.md", "/dev/fundamentals/hyperscaling.md"],
    },
    {
