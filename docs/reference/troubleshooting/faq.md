...
- **Future Proof** - Ecosystem projects that adopt zkSync Era now will enjoy all future improvements without the need to change their code, in particular coming from:
  ...
  - The compiler: integration of LLVM-enabled modern programming languages. [Learn more about our compiler toolchain](../../tools/compiler-toolchain/README.md).
  - Other innovations like [Hyperchains, Hyperbridges and ZK Stack](../concepts/hyperscaling.md).
...
You can find more information about the [differences between Ethereum and zkSync Era in this section of the docs](../../reference/architecture/differences-with-ethereum.md).
:::
...
Read more about [Hyperscalability and ZK Stack here](../concepts/hyperscaling.md).
:::
