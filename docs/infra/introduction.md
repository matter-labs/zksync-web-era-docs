...
head:
  - - meta
    - name: "twitter:title"
      content: zkSync Node | zkSync Docs
---
...
In Ethereum terms, the current state of the zkSync node represents an archive node, providing access to the entire history of the
blockchain.
