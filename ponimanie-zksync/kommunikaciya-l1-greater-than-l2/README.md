...
* `_ergsLimit` - параметр, включающий себя лимит ergs за вызов транзакции. Вы можете узнать больше про egrs и систему комиссий zkSync [здесь](../mekhanizm-komissii/).
...
* `_ergsLimit` - параметр включает в себя лимит ergs для вызываемой транзакции. Вы можете узнать больше об ergs и систему комиссий zkSync [тут](../mekhanizm-komissii/).
...
// инициация трансфера на L2 через исполнение на L1 из кошелька zkSync
