...
Отличный пример использования данного узла через наш SDK можно найти [здесь](broken-reference).
...
Возвращает адрес [testnet paymaster](broken-reference)'a: paymaster'a, доступного в тестнете и позволяющего оплачивать комиссии в токенах ERC-20.
